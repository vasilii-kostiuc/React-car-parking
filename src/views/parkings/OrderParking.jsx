...
function OrderParking() {
  ...
  async function handleSubmit(event) {
    ...
    await startParking({ vehicleId, zoneId })
  }
    ...
    <form onSubmit={ handleSubmit } noValidate>
      <div className="flex flex-col mx-auto md:w-96 w-full">
        ...
        <div className="flex flex-col gap-2 mb-4">
          <label htmlFor="vehicleId" className="required">Vehicle</label>
          <select
            id="vehicleId"
          ...
          <ValidationError errors={ errors } field="vehicleId" />
        </div>
 
        <div className="flex flex-col gap-2">
          <label htmlFor="zoneId" className="required">Zone</label>
          <select
            name="zoneId"
            id="zoneId"
            value={ zoneId }
          ...
          <ValidationError errors={ errors } field="zoneId" />
